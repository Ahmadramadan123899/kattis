def atableoftwoqueues(lines: list[str]) -> str:
    ...
    Args:
        lines (list[str]): first line the user should enter the number of people in the queue at the left
                           the at the right
                           Second line, we have to enter the time in second for each person waiting in the
                           queue at the left
                           third line, we have to enter the time in second for each person waiting 
                           in the queue at the right
    Returns:
