...
def towering(data: list[int]) -> list[int]:
    ...
    Args:
        ...
        The input consists of eight positive integers. 
        The first six represent the heights of the six boxes. 
        ...
        All box heights will be < or equal to 100 and the sum of the box heights will equal 
        the sum of the tower heights.

    Returns:
        list[int]:Output the heights of the three boxes in the first tower
